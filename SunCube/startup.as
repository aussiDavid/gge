	...
	;This licence will expire on Mon, 23 Aug 2010
	...
	; Compiler options:
	;
	; -oSunCubeC2.cof -mSunCubeC2.map --summary=default --output=default \
	; SunPos.p1 \
	; C:\Program Files\HI-TECH Software\PICC-18\PRO\9.63\lib\plib-18F14K22.lpp \
	; --chip=18F14K22 -P --runtime=default --opt=default -Blarge \
	; --double=32 --cp=16 -g --asmlist \
