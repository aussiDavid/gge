...
;-----------------------------------------------------------------------
	...
	mov24	AA,SAA			;AA saved
	mov24	BB,SBB			;BB saved
...
doWUp					;handle sleep delay
	...
	goto	intfin			;not zero so go do tod stuff
	...
	goto	intfin			;no so skip double dec of wakeup timer
...
intfin
	mov24	SAA,AA			;AA restored
	mov24	SBB,BB			;BB restored
